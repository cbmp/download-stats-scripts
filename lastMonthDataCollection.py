...
if __name__ == "__main__":
    ...
    month = datetime.datetime.today().month-1 #"%02d" % (datetime.datetime.today().month-1) 

    data = None
   
    # get json from data file
    path = "" + str(os.getcwd()) + "\\data.json"
    with open(path) as f:
        data = json.load(f)

    # TODO: sort the json as a sanity check
